...
class XMLFetcher:
    ...
    def _parse_veiculo(self, veiculo_element: ET.Element) -> Dict:
        ...
        """
        # Pega o preço em centavos primeiro
        preco_centavos = self._get_element_text(veiculo_element, 'preco', int)
        
        # Converte para reais se existir
        preco_reais = None
        if preco_centavos is not None:
        ...
        veiculo_data = {
            ...
            'preco': preco_reais,  # Já em reais, não centavos
